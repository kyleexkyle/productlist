...
const form = useForm({
    ...
    category: props.data.product.data.category.id,
    description: props.data.product.data.description,
    images: {},
    dateTime: props.data.product.data.date_time,
});

const validationSchema = [
    yup.object({
        name: yup.string().required().label('Name'),
        category: yup.number().integer().required().label('Category'),
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <Field class="shadow-sm px-2 rounded-lg w-full"
                                        ...
                                        <template  v-for="(category) in data.productCategories.data">
